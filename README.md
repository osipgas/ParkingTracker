...
- **parking_tracker_app**: Сontains files and resources for developing and running an application using Parking Tracker. The application is being created by contributor of this project Zakhar. The application is still under development and not ready for use.
